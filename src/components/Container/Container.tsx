...
export const Container = ({ settings, changeSettings }: ContainerProps) => {
  ...
  const [currentLocationName, setCurrentLocationName] = useState<string>("Islamabad");
  // const [mapLocation, setMapLocation] = useState<MapLocationModel>(MapLocation);
 ...
 const  MapLocation ={
    ...
    temp:currentWeatherSelectedItem.temp,
    unit:settings.unit
  }
  return (
